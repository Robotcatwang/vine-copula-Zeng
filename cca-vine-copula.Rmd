...
经过前文所述的计算后，各板块的系统性风险指标如下图所示：

```{r industry-sector-dd,eval=T,fig.cap = "金融各板块近十年系统性风险时序图", dev='png'}
...
stock=data_dd[,5]
bank=data_dd[,6]
plot(dd_date,insurance,type="l",col= 'red')
lines(dd_date,multi_finance,type="l",col= 'yellow')
lines(dd_date,house,type="l",col= 'blue')
lines(dd_date,stock,type="l",col= 'green')
lines(dd_date,bank,type="l",col= 'pink')
```
