\documentclass[$if(fontsize)$$fontsize$,$endif$$if(lang)$$babel-lang$,$endif$$if(handout)$handout,$endif$$if(beamer)$ignorenonframetext,12pt,xcolor=dvipsnames,aspectratio=1610,hyperref={bookmarksdepth=4}$endif$$for(classoption)$$classoption$$sep$,$endfor$]{$documentclass$}
...
\logo{\includegraphics[height=1.7cm]{znufelogo.jpg}{\vspace{+3pt}}{\hspace{+8pt}}}
